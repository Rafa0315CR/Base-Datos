...
y el salario anual de los empleados que sumen entre
 salario anual y comisión los 3 millones.(6 PERSONAS)*/
 


 /* 5.	Mostrar apellido, oficio, y depto de los empleados 
ordenados por departamento y dentro de este 
por oficio para tener una visión jerárquica.*/
...
O también incluimos aquellos que no siendo analista pertenecen 
